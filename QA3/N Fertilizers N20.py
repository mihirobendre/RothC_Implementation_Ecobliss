...
urea_mass_t = 100 / 1000  # tonnes of urea ... kg/ha * tons/kg * area
npk_mass_t = 200 / 1000  # tonnes of NPK 15-15-15
...
N2O_direct_per_ha = N2O_direct_total
...
N2O_volat_per_ha = N2O_volat_total
...
N2O_leach_per_ha = N2O_leach_total
...
N2O_total_per_ha = N2O_total_t

baseline_emissions = N2O_total_per_ha
...
# Fertilizer application (t of fertilizer applied per year)
urea_mass_t = 62.5 / 1000  # tonnes of urea ... kg/ha * tons/kg * area
npk_mass_t = 125 / 1000 # tonnes of NPK 15-15-15
...
N2O_total_t = N2O_direct_total + N2O_volat_total + N2O_leach_total
N2O_total_per_ha = N2O_total_t
project_emissions = N2O_total_per_ha
'''
...
net_emission_reductions = baseline_emissions - project_emissions

print('Net ERs (tCO2e/ha): ', net_emission_reductions)
