...
# >> Example default: 5.5 t DM/ha for agricultural residues (IPCC 2006 GL Vol 4, Ch 2, Table 2.4).
MB_prj = 8.451  # t DM/ha

# >> Typical IPCC default for residues: 0.9.
CF = 1  # unitless  average between early/mid/late season burns in savannah grasslands
...
print(f"Per-ha N2O emissions (baseline) = {n2o_co2e_bsl_per_ha:.8f}")
print(f"Total N2O emissions (project) = {total_n2o_co2e_project:.8f}")
print(f"Per-ha N2O emissions (project) = {n2o_co2e_prj_per_ha:.8f}")
